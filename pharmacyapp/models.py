...
class Post(models.Model):
    ...
    netPurchasePrice = models.DecimalField(max_digits=6, decimal_places=2,validators=[MinValueValidator(Decimal('0.01'))])
    mrp = models.DecimalField(max_digits=5, decimal_places=2,validators=[MinValueValidator(Decimal('0.01'))])
    ...
    pricePerTablet = models.DecimalField(max_digits=5, decimal_places=2,default ='0.01',validators=[MinValueValidator(Decimal('0.01'))])
...
class Bill(models.Model):
    ...
    pricePerTablet = models.DecimalField(max_digits=5, decimal_places=2,default ='0',validators=[MinValueValidator(Decimal('0.01'))])
    totalPrice = models.DecimalField(max_digits=5, decimal_places=2,default ='0',validators=[MinValueValidator(Decimal('0.01'))])
    discount = models.PositiveSmallIntegerField("Discount (%)",choices=Discount,default ='0')
    discountedPrice = models.DecimalField(max_digits=5, decimal_places=2,default ='0',validators=[MinValueValidator(Decimal('0.01'))])
    ...
    returnDiscountedPrice=models.DecimalField(max_digits=5, decimal_places=2,default ='0',validators=[MinValueValidator(Decimal('0.01'))])
