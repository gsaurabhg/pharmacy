...
class Post(models.Model):
    ...
    pricePerStrip = models.DecimalField(max_digits=5, decimal_places=2)
    netPurchasePrice = models.DecimalField(max_digits=6, decimal_places=2)
    ...
    pricePerTablet = models.DecimalField(max_digits=5, decimal_places=2,default ='0')
...
class Bill(models.Model):
    ...
    discountedPrice = models.DecimalField(max_digits=5, decimal_places=2,default ='0')
    ...
    returnDiscountedPrice=models.DecimalField(max_digits=5, decimal_places=2,default ='0')
...
class returnBill(models.Model):
    ...
    originalPricePerTablet = models.DecimalField(max_digits=5, decimal_places=2)
    ...
    returnSalesBillDate = models.DateField("Date Of Return",default=timezone.now)
    returnSalesNoOfTablets = models.PositiveSmallIntegerField(default ='0')
    returnSalesDiscountedPricePerTablet = models.DecimalField(max_digits=5, decimal_places=2)
    totalReturnAmount = models.DecimalField(max_digits=5, decimal_places=2)
    def __str__(self):
